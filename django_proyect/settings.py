...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # Esta línea añade el directorio 'templates' en tu BASE_DIR
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1','djangorailway-production-6a6d.up.railway.app']
